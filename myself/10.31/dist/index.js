...
function showUpdateDialog(id){
    ...
    // 根据对应id对应文中的数据
    curUpdateArticle=articleList.find(v=>v.id===id)
    $('.dialog input').value=curUpdateArticle.title
    $('.dialog textarea').value=curUpdateArticle.content
...
$('.cancel').addEventListener('click',()=>{
    ...
    curUpdateArticle=null
})
// 点击确定
$('.confirm').addEventListener('click',()=>{
    const params={
     title:$('.dialog-content input').value.trim(),
     content:$('.dialog-content textarea').value.trim()
    }
